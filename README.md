...
* **AI/ML Engine:** Detects outbreak patterns using Gemini/OpenAI API
...
- Weekly data analysis using Gemini/OpenAI API
...
3. **AI Processing:** Sends structured data to Gemini/OpenAI with epidemiologist prompt
4. **Risk Assessment:** AI returns risk level, confidence score, and predicted disease
5. **Visualization:** Results displayed on dashboard with color-coded risk cards
